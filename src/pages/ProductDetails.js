...
const ProductDetails = ({ cart, addToCart, decreaseQty }) => {
    ...
    const stripPrice = isStripCategory ? (packPrice / stripsPerPack) : packPrice;
    const oldStripPrice = isStripCategory ? (oldPackPrice / stripsPerPack) : oldPackPrice;
    ...
    const handleAdd = () => {
        const itemToAdd = {
            ...
            name: `${product.name} (${selectedUnit === 'pack' && isStripCategory ? 'Pack' : ''})`
        };
        addToCart(itemToAdd);
    };
                ...
                <Col md={7}>
                    ...
                    <div className="d-flex gap-3">
                        ...
                        {!isOutOfStock ? (
                            ...
                            <Button variant="secondary" size="lg" className="w-50" disabled>
                                Out of Stock
                            </Button>
                        )}
                    </div>
